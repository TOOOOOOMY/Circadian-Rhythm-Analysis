...
def visualizer(file_name, # include .csv -> sample.csv
        ...
        try:
            ...
            try:
                ...
                if over_view_plot_switch == 1:
                    colored_overview_n_columns(X_axis, new_data, all_data, data_name, Yaxis, overwrite_column_number, x_axis_title, y_axis_title)
                else:
                    pass

                if len(overlap_dict) > 0:
                    overlap_write(overlap_dict, X_axis, new_data, all_data, data_name, Yaxis, column_number, x_axis_title, y_axis_title)
                else :
                    pass
    ...
    def overlap_write(overlap_dict, X_axis, new_data, all_data, data_name, Yaxis, column_number, x_axis_title, y_axis_title):
        ...
        for title in overlap_dict.keys():
            ...
            each_title = '{0}, {1}well ({2}%)'.format(title, data_lenght, data_percentage)
